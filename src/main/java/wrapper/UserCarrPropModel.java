...
public class UserCarrPropModel implements Serializable {
    private int id;
    ...
    public UserCarrPropModel(){
        
    }
    
    public UserCarrPropModel(int Id,int IdSisUsuario,String Codcarr,String Nombre){
        this.id=Id;
